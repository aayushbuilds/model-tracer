...
const SearchBar: React.FC<SearchBarProps> = ({
    ...
    return (
        <div className="relative">
            <div
                className="flex items-center bg-white border-2 border-gray-200 rounded-lg focus-within:border-gray-300 focus-within:ring-2 focus-within:ring-transparent">
