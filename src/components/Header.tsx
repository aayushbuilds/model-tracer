    ...
    return (
        <div className="flex flex-row items-center justify-between top-0 z-50 bg-[#FDFDFD] px-9 -mx-9">
            <div className="py-6 flex flex-col items-start">
                <h1 className="text-3xl text-black font-bold" style={{ fontFamily: 'var(--font-alpha-lyrae)' }}>{title}</h1>
                <h1 className="text-md text-gray-400 font-bold" style={{ fontFamily: 'var(--font-alpha-lyrae)' }}>{subtitle}</h1>
            </div>
